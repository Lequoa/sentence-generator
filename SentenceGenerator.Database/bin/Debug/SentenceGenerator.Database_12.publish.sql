...
GO
PRINT N'Creating Table [dbo].[Sentence]...';
...
CREATE TABLE [dbo].[Sentence] (
    ...
    [UserId]       INT            NOT NULL,
    CONSTRAINT [PK_Sentence] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
ALTER TABLE [dbo].[Sentence] WITH CHECK CHECK CONSTRAINT [FK_Sentences_User];
